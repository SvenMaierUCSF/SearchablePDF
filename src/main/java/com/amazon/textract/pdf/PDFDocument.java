...
public class PDFDocument {
    ...
    private boolean showOverlayedText = false;

    public PDFDocument(boolean showOverlayedText){
        this.showOverlayedText = showOverlayedText;
        this.document = new PDDocument();
    }

    public PDFDocument(InputStream inputDocument ,boolean showOverlayedText) throws IOException {
        this.showOverlayedText = showOverlayedText;
